...
4) If you want to make this change permanent in your project, you should include that APP Server in ``CSP.ini`` file in _.\\webgatewayconfig\\loadbalancer_ folder (look at the content, the changes to do are pretty straightforward).
### If you're all set...
